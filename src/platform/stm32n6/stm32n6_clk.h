...
#define RCC_CCIPR1        (RCC_BASE + 0x144)
...
#define CLK_VREFBUF   CLK_ID(RCC_APB3ENR, 15)
...
#define CLK_TIM13     CLK_ID(RCC_APB1LENR, 7)
#define CLK_TIM14     CLK_ID(RCC_APB1LENR, 8)
#define CLK_TIM10     CLK_ID(RCC_APB1LENR, 12)
#define CLK_TIM11     CLK_ID(RCC_APB1LENR, 13)
#define CLK_TIM1      CLK_ID(RCC_APB2ENR, 0)
#define CLK_TIM8      CLK_ID(RCC_APB2ENR, 1)
#define CLK_TIM18     CLK_ID(RCC_APB2ENR, 15)
#define CLK_TIM15     CLK_ID(RCC_APB2ENR, 16)
#define CLK_TIM16     CLK_ID(RCC_APB2ENR, 17)
#define CLK_TIM17     CLK_ID(RCC_APB2ENR, 18)
#define CLK_TIM9      CLK_ID(RCC_APB2ENR, 19)

#define CLK_HPDMA1    CLK_ID(RCC_AHB5ENR, 0)
#define CLK_GPDMA1    CLK_ID(RCC_AHB5ENR, 4)
