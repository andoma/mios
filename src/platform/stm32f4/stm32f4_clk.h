...
#define CLK_GPIOA CLK_ID(CLK_AHB1, 0)
#define CLK_GPIOB CLK_ID(CLK_AHB1, 1)
#define CLK_GPIOC CLK_ID(CLK_AHB1, 2)
#define CLK_GPIOD CLK_ID(CLK_AHB1, 3)
#define CLK_GPIOE CLK_ID(CLK_AHB1, 4)
#define CLK_GPIOF CLK_ID(CLK_AHB1, 5)
#define CLK_GPIOG CLK_ID(CLK_AHB1, 6)
#define CLK_GPIOH CLK_ID(CLK_AHB1, 7)
#define CLK_GPIOI CLK_ID(CLK_AHB1, 8)
#define CLK_GPIOJ CLK_ID(CLK_AHB1, 9)
#define CLK_GPIOK CLK_ID(CLK_AHB1, 10)
